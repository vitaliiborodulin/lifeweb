...
<div class="text-2">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-10">
                <p>Скорость решения проблем является важным фактором.Мы понимаем это и стараемся всегда оперативно реагировать и устранять сложности.</p>
                <p>Мы сфокусируемся на самых важных проблемах, чтобы максимально эффективно использовать имеющиеся ресурсы и оптимизировать расход бюджета.</p>
                <p>ПОДДЕРЖКА<br> Мы полностью берем ответственность за выполняемые работы и готовы гарантировать их качество.</p>
            </div>
        </div>
    </div>
</div>
